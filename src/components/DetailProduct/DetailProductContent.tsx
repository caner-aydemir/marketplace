            ...
            <div className="flex gap-4 pt-4">
                {colorsData.map((color) => (
                    <button
                        ...
                        className={`relative flex items-center justify-center gap-2 border rounded-md text-sm px-10 py-2 transition-all ${
        ...
        ></span>
                        <span
                            className={`font-medium ${
                                selectedColor === color.id ? "text-black" : "text-gray-500"
                            }`}
                        >
          {color.name}
        </span>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
                {featuresData.map((feature) => (
                    ...
                    >
                        <h4
                            className={`font-bold ${
                                selectedFeature === feature.id ? "text-green-600" : "text-gray-800"
                            }`}
                        >
                            {feature.title}
                        </h4>
